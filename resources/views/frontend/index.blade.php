                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="tp-hero">
                        <div class="tp-hero__section-box">
                            <h4 class="tp-section-subtitle  wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".3s">Best Social Earning Platform</h4>
                            <h2 class="tp-slider-title wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".6s">Get paid for Posting Adverts on Your Social Media</h2>
                            <p class="wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".8s">Earn daily income by posting adverts and performing simple tasks for top businesses and brands on you social media account </p>
                        </div>
                        <div class="tp-hero__wrapper d-flex align-items-center wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                            <div class="tp-hero__button">
                                <a class="tp-btn" href="{{ url('/register') }}">CREATE FREE ACCOUNT</a>
                            </div>
                ...
                <div class="col-xl-5 col-lg-5 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".3s">
                    <div class="tp-slider-exprience">
                        <div class="tp-slider-exprience__content">
                            <h4 class="tp-slider-exp-title">Testimonial</h4>
                            <p><b>
                                    This is the best ADS platform. I got 5000 real followers and it's so cheap and fast.
                                </b></p>
                        </div>
                        <div class="tp-slider-exprience__client-info d-flex align-items-center">
                            ...
                            <div class="tp-slider-exprience__meta">
                                <h5 class="tp-client-name">Adesanya Oluwaseun</h5>
                                <span>Founder of ONESUB Enterprice</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".5s">
                            <div class="tp-slider-exp-item mb-30">
                                ...
                                <div class="tp-slider-exp-item__content">
                                    <h4 class="tp-exp-sm-title">Get People to Post <br> your Adverts on <br>their Social Media Account</h4>
                                    <em>
                                        Get people with at least 1,000 followers to post your adverts and perform social tasks for you on their social media account.
                                    </em>
                                </div>
                                <br>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
                            <div class="tp-slider-exp-item mb-30">
                                ...
                                <div class="tp-slider-exp-item__content">
                                    <h4 class="tp-exp-sm-title">Get paid for Posting Adverts on Your Social Media Account </h4>
                                    <em>
                                        Earn steady income by posting adverts and performing social task for businesses and top brands on your social media account.
                                    </em>
                                </div>
                                <br>
                                <div class="tp-slider-exp-item__service-link">
                ...
                <div class="col-xl-5 col-lg-5 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
                    <div class="service-section-wrapper">
                        <div class="tp-service-section-title-box">
                            ...
                            <h3 class="tp-section-title">Experience the Power of Viral Advertising</h3>
                        </div>
                    ...
                    <div class="row service-space-left">
                        <div class="col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
                            <div class="tp-service-item mb-20 d-flex justify-content-between">
                                <div class="tp-service-item__content">
                                    <h4 class="tp-service-sm-title"><a href="{{ url('/register') }}">Massive Advert Views</a></h4>
                        ...
                        <div class="col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                            <div class="tp-service-item sv-color-blue-one mb-20 d-flex justify-content-between">
                                <div class="tp-service-item__content">
                                    <h4 class="tp-service-sm-title"><a href="{{ url('/register') }}">Affordable Pricing</a></h4>
                                    <div class="tp-service-item__button-link">
                                        <a href="{{ url('/register') }}">
                                            <span>
                                                <svg width="34" height="16" viewBox="0 0 34 16" fill="none" xmlns="http://www.w3.org/2000/svg">
