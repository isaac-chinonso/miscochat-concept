...
@section('title')
Engagement Task Orders || Miscochat Concept
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="banner-btn" align="center">
                ...
                <p>Engagement tasks are created to get people to perform simple tasks for you on their social media account.</p>
            </div><br>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="account-card">
                    <h3 class="account-title">Engagement Task Orders </h3>
                    <div class="orderlist">
                            ...
                            <table class="table table-stripped table-list">
                                <thead>
                                    <tr style="background-color: #5f04f6;">
                                        ...
                                        <th class="text-white">Advert Link</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ $ord->image }}">{{ $ord->image }}</a></td>
                                        <td>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('deleteuserengagementorder',$ord->id) }}" class="btn btn-danger" style="padding: 7px 8px 7px 8px;font-size:12px;">Delete Product</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
