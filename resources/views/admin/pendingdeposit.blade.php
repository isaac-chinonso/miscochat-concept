...
@section('title')
Pending Deposit History || Miscochat Concept
@endsection
@section('content')
    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="page-title">Pending Deposit</h3>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i class="ti ti-home"></i></a></li>
                                <li class="breadcrumb-item" aria-current="page">Deposit</li>
                                <li class="breadcrumb-item active" aria-current="page">Pending Deposit</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $number = 1; ?>
                                        @foreach($pendingdeposit as $transact)
                                        <tr>
                                            <td>
                                                <h6>{{ $number }}</h6>
                                            </td>
