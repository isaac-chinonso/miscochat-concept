...
@section('title')
Active Withdrawal History || Miscochat Concept
@endsection
@section('content')
    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="page-title">Active Withdrawal</h3>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i class="ti ti-home"></i></a></li>
                                <li class="breadcrumb-item" aria-current="page">Withdrawal</li>
                                <li class="breadcrumb-item active" aria-current="page">Active Withdrawal</li>
                            </ol>
                        </nav>
                    </div>
                </div>
