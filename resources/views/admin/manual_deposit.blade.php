...
@section('title')
Manual Deposit || Miscochat Concept
@endsection
@section('content')
    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="page-title">Manual Deposit</h3>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i class="ti ti-home"></i></a></li>
                                <li class="breadcrumb-item" aria-current="page">Deposit</li>
                                <li class="breadcrumb-item active" aria-current="page">Manual Deposit</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <table class="table table-stripped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $user->wallet->first()->balance + $user->referralwallet->first()->balance }}</td>
                                            <td>
                                                @if($user->activated == 0)
                                            ...
                                            <td>
                                                <button class="btn-info btn-sm" data-toggle="modal" data-target="#modal-default{{ $user->id }}">Fund User</button><br>
                                            </td>
                                            <!-- modal Area -->
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Finance User</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <form method="POST" action="{{ url('admin/add-deposit') }}">
                                                            @csrf
                                                            ...
                                                            <div class="modal-footer" align="right">
                                                                ...
                                                                <button type="submit" class="btn btn-info">Fund User</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <!-- /.modal-content -->
